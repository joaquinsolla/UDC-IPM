...
class View:
    ...
    def show_all(self):
        ...
        self.next.hide()   # Ocultamos la flecha de avanzamos
    ...
    def build_ventana_4(self, nombreContactoDe, contactosUsuario, currentPage, totalPages):
        ...
        #self.labelHistorialRastreado.set_markup("<big><b>Contactos de " + dataPersona[0][0] + ":</b></big>")    # Creación de campo texto con los datos del usuario buscado
